...
////////////////////////////////////////////////////////////////*KAISERSOSE*/////////////////////////////////////////////////////////////////////////////////////////    
	...
	function parse(){
		...
		if (isset($_SESSION['admin'])) {
			...
			$this->setContent("user.username", $_SESSION['admin']['username']);
			$this->setContent("user.name", $_SESSION['admin']['name']);
			$this->setContent("user.surname", $_SESSION['admin']['surname']);
			$this->setContent("user.lastlogin", $_SESSION['admin']['lastlogin']);
		
			$this->setContent("user.email", $_SESSION['admin']['email']);
		}
